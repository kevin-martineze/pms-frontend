...
export const en = {
  ...
  admin: {
    ...
    login: {
      ...
      forgotBody: "Enter your email and we will send a link to choose a new password.",
      forgotSubmit: "Send the link",
      forgotSentTitle: "Done",
      forgotSentBody: "If that email has an account, a link is on its way. Check the spam folder too.",
      backToLogin: "Back to sign in",
      resetTitle: "Choose a new password",
      resetBody: "Saving it closes every open session on your account.",
      newPassword: "New password",
      passwordHint: "At least 10 characters. A short phrase beats an odd symbol.",
      passwordShort: "Needs at least 10 characters.",
    ...
    calendar: {
      ...
      sheet: {
        ...
        edited: (name: string) => `${name}'s booking was updated.`,
        requoteNote: "If you change the dates, the price is recalculated against current rates.",
        badRange: "Check-out must be after check-in.",
        notes: "Notes",
        saving: "Saving…",
    ...
    reports: {
      ...
      revenueNet: "excl. tax",
      taxCollected: (amount: string) => `${amount} of tax collected separately`,
      ...
      sourceTitle: "Where each booking came from",
      sourceSub: "What comes through the hotel's own site pays commission to nobody.",
      colSource: "Source",
    ...
    noAccess: {
      ...
      body: (section: string) =>
        `Your account has no access to ${section}. If you need it for your job, ask management.`,
