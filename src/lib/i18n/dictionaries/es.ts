...
export const es: Dictionary = {
  ...
  admin: {
    ...
    reports: {
      ...
      commissionHint: (pct) => `${pct}% del ingreso vino sin comisión`,
      ...
      channelCostTitle: "Lo que costó cada canal",
      colChannel: "Canal",
      colCommission: "Comisión",
      ownTag: "propio",
      originTitle: "De dónde vienen los huéspedes",
      originSub: "Decide en qué idiomas vale la pena invertir primero.",
    },
  },
