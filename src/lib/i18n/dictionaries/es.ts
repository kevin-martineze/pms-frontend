...
export const es: Dictionary = {
  ...
  admin: {
    ...
    login: {
      ...
      forgotBody: "Poné tu correo y te mandamos un enlace para elegir una contraseña nueva.",
      forgotSubmit: "Mandar el enlace",
      forgotSentTitle: "Listo",
      forgotSentBody: "Si ese correo tiene una cuenta, le llega un enlace. Revisá también el correo no deseado.",
      backToLogin: "Volver a entrar",
      resetTitle: "Elegí una contraseña nueva",
      resetBody: "Al guardarla se cierran todas las sesiones abiertas de tu cuenta.",
      newPassword: "Contraseña nueva",
      passwordHint: "Al menos 10 caracteres. Una frase corta funciona mejor que un símbolo raro.",
      passwordShort: "Necesita al menos 10 caracteres.",
    ...
    calendar: {
      ...
      sheet: {
        ...
        edited: (name) => `Se actualizó la reserva de ${name}.`,
        requoteNote: "Si cambiás las fechas, el precio se recalcula con las tarifas vigentes.",
        badRange: "La salida debe ser posterior a la entrada.",
        notes: "Notas",
        saving: "Guardando…",
        saveChanges: "Guardar cambios",
        editCancel: "Descartar",
